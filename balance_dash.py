...
start_date = st.sidebar.slider("Start Date", min_value=data['Date_Formatted'].min(), max_value=data['Date_Formatted'].max())
end_date = st.sidebar.slider("End Date", min_value=data['Date_Formatted'].min(), max_value=data['Date_Formatted'].max(), value=data['Date_Formatted'].max())
